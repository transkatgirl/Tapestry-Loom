...
pub struct SnippetContent {
    ...
    pub content: Vec<u8>,
    /// The [`Model`] which generated the snippet, if any.
...
pub struct TokenContent {
    ...
    /// The [`Model`] which generated the tokens, if any.
    ///
    /// This should be left blank if the text was tokenized by the model but not generated by it.
    pub model: Option<NodeModel>,
    /// Metadata associated with the content.
    pub metadata: Option<HashMap<String, String>>,
}
...
pub struct DiffContent {
    ...
    pub content: Diff,
    /// The [`Model`] which generated the modification set, if any.
    pub model: Option<NodeModel>,
    /// Metadata associated with the content.
    pub metadata: Option<HashMap<String, String>>,
}
