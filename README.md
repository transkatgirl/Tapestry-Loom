...
Once a tokenization endpoint is configured for a model, enabling the setting "(Opportunistically) reuse output token IDs" can improve output quality, especially in weaves where most nodes are being generated by one model rather than an ensemble of models.
