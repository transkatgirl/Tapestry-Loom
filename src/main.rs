...
fn format_large_number_detailed(
    ...
    if number >= 100_000_000_000 {
        format!("{:.0}B {plural_suffix}", number as f32 / 1_000_000_000.0)
    } else if number >= 10_000_000_000 {
        format!("{:.1}B {plural_suffix}", number as f32 / 1_000_000_000.0)
    } else if number >= 1_000_000_000 {
        format!("{:.2}B {plural_suffix}", number as f32 / 1_000_000_000.0)
...
fn format_file_size(size: usize) -> String {
    if size >= 100_000_000_000_000 {
        format!("{:.0} TB", size as f32 / 1_000_000_000_000.0)
    } else if size >= 1_000_000_000_000 {
        format!("{:.1} TB", size as f32 / 1_000_000_000_000.0)
    } else if size >= 100_000_000_000 {
