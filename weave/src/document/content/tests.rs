...
fn modification_range_apply_annotations() {
    ...
    let metadata = [
        HashMap::from([("index".to_string(), "0".to_string())]),
        HashMap::from([("index".to_string(), "1".to_string())]),
        HashMap::from([("index".to_string(), "2".to_string())]),
        HashMap::from([("index".to_string(), "3".to_string())]),
        HashMap::from([("index".to_string(), "4".to_string())]),
        HashMap::from([("index".to_string(), "5".to_string())]),
        HashMap::from([("index".to_string(), "6".to_string())]),
        HashMap::from([("index".to_string(), "7".to_string())]),
        HashMap::from([("index".to_string(), "8".to_string())]),
        HashMap::from([("index".to_string(), "9".to_string())]),
        HashMap::from([("index".to_string(), "10".to_string())]),
        HashMap::from([("index".to_string(), "11".to_string())]),
        HashMap::from([("index".to_string(), "12".to_string())]),
    ];
    ...
    assert_eq!(
        *cursor.as_list(),
        LinkedList::from([ContentAnnotation {
            len: 4,
            metadata: Some(&metadata[0])
        }])
    );
    assert!(
        ModificationRange::Deletion(Range { start: 0, end: 4 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Insertion(Range { start: 4, end: 7 }).apply_annotations(
            &mut location,
            &mut cursor,
    ...
    assert!(
        !ModificationRange::Insertion(Range { start: 4, end: 4 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ...
        .apply_annotations(
            ...
            &mut cursor,
            |_| { panic!() },
            |annotation, index| { annotation.metadata = Some(&metadata[index]) },
            |_| { panic!() },
            |_| { panic!() }
        )
    );
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 7, end: 9 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 11, end: 13 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 7, end: 10 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 6, end: 8 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 9, end: 11 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 0, end: 2 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 1, end: 2 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 3, end: 9 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ...
        .apply_annotations(
            ...
            &mut cursor,
            |_| { panic!() },
            |annotation, index| { annotation.metadata = Some(&metadata[3 + index]) },
            |_| { panic!() },
            |_| { panic!() }
        )
    );
    ...
    assert!(
        ModificationRange::Deletion(Range { start: 7, end: 13 }).apply_annotations(
            &mut location,
            &mut cursor,
            |_| { panic!() },
            |_, _| { panic!() },
    ...
    assert!(
        ...
        .apply_annotations(
            ...
            &mut cursor,
            |_| { panic!() },
            |annotation, index| { annotation.metadata = Some(&metadata[4 + index]) },
            |_| { panic!() },
            |_| { panic!() }
        )
    );
    ...
    assert!(
        ...
        .apply_annotations(
            ...
            &mut cursor,
            |_| { panic!() },
            |annotation, index| { annotation.metadata = Some(&metadata[12 + index]) },
            |_| { panic!() },
            |_| { panic!() }
        )
    );
