...
fn update_node_activity_not_in_place() {
    ...
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 0), true, false);
    assert_eq!(nodes.len(), 15);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 1), true, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, true);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 1), false, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 0), false, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 0), true, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, true);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 1), true, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, true);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, true);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 1), false, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, true);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(0, 0), false, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(1, 7), true, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(1, 5), true, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(1, 6), true, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    assert_eq!(nodes.get(&Ulid::from_parts(1, 9)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(1, 10)).unwrap().active, false);
    update_node_activity(&mut nodes, &Ulid::from_parts(1, 10), true, true);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
    ...
    update_node_activity(&mut nodes, &Ulid::from_parts(1, 10), false, false);
    assert_eq!(nodes.len(), 15);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 0)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 1)).unwrap().active, false);
    assert_eq!(nodes.get(&Ulid::from_parts(0, 2)).unwrap().active, false);
